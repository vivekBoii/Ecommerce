              ...
              <Menu>
                ...
                <MenuList p={5}>
                  ...
                  <HStack justify={"space-between"}>
                    <Button size='sm' onClick={rangeCancel} colorScheme='green'>
                      cancel
                    </Button>
              ...
              <Menu>
                ...
                <MenuList p={5}>
                  ...
                  >
                    ...
                    <SliderMark value={20}>1</SliderMark>
                    <SliderMark value={40}>2</SliderMark>
                    <SliderMark value={60}>3</SliderMark>
                    <SliderMark value={80}>4</SliderMark>
                    <SliderMark value={100}>5</SliderMark>
                    <SliderTrack>
                      <SliderFilledTrack />
                    </SliderTrack>
                    <SliderThumb />
